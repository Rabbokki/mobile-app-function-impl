          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('삭제 시 모든 데이터가 영구적으로 제거됩니다. 이 작업은 되돌릴 수 없습니다.'),
                const SizedBox(height: 12),
                OutlinedButton(
            ...
            child: Column(
              ...
              children: [
                ...
                SwitchListTile(
                  ...
                  subtitle: const Text('친구 활동 및 소셜 업데이트를 받습니다.'),
                  value: _socialNotification,
                  onChanged: (v) => setState(() => _socialNotification = v),
                ),
                const Divider(),
                SwitchListTile(
                  title: const Text('서비스 업데이트'),
                  subtitle: const Text('서비스 변경 및 업데이트 정보를 받습니다.'),
                  value: _updatesNotification,
                  onChanged: (v) => setState(() => _updatesNotification = v),
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      onPressed: _handleSaveNotifications,
